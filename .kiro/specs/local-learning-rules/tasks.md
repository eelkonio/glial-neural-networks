...
- [x] 1. Set up project structure and shared infrastructure
  ...
  - [x] 1.2 Set up data pipeline in `code/data/fashion_mnist.py`
  ...
  - [x]* 1.3 Write property tests for data pipeline (Properties 9, 15)
...
- [x] 2. Implement network architecture
  - [x] 2.1 Implement `LayerState` dataclass and `LocalLearningRule` protocol in `code/rules/base.py`
  ...
  - [x] 2.2 Implement `LocalLayer` in `code/network/local_layer.py`
  ...
  - [x] 2.3 Implement `LocalMLP` in `code/network/local_mlp.py`
  ...
  - [x]* 2.4 Write property tests for network architecture (Properties 1, 2, 3)
...
- [x] 3. Implement Hebbian and Oja's rules (quick baselines)
  - [x] 3.1 Implement `HebbianRule` in `code/rules/hebbian.py`
  ...
  - [x] 3.2 Implement `OjaRule` in `code/rules/oja.py`
  ...
  - [x]* 3.3 Write property tests for Hebbian and Oja (Properties 4, 5)
...
- [x] 4. Checkpoint — Verify infrastructure and baselines
...
- [x] 5. Implement three-factor learning rule (CRITICAL — substrate for Step 13)
  - [x] 5.1 Implement third-factor signal providers in `code/rules/three_factor.py`
  ...
  - [x] 5.2 Implement `ThreeFactorRule` in `code/rules/three_factor.py`
  ...
  - [x]* 5.3 Write property tests for three-factor rule (Properties 6, 7)
...
- [x] 6. Implement forward-forward algorithm
  - [x] 6.1 Implement `ForwardForwardRule` in `code/rules/forward_forward.py`
  ...
  - [x]* 6.2 Write property tests for forward-forward (Properties 8, 9, 10)
...
- [x] 7. Implement predictive coding rule
  - [x] 7.1 Implement `PredictiveCodingRule` in `code/rules/predictive_coding.py`
  ...
  - [x]* 7.2 Write property test for predictive coding (Property 11)
...
- [x] 8. Implement backpropagation baseline
  - [x] 8.1 Implement backprop training loop in `code/experiment/runner.py`
...
- [x] 9. Checkpoint — Verify all learning rules train
  - Ensure all tests pass, ask the user if questions arise.
...
- [x] 10. Implement experiment infrastructure
  - [x] 10.1 Implement `ExperimentRunner` in `code/experiment/runner.py`
  ...
  - [x] 10.2 Implement `PerformanceMetrics` in `code/experiment/metrics.py`
  ...
  - [x] 10.4 Implement comparison and visualization in `code/experiment/comparison.py`
...
- [x] 11. Implement deficiency analysis
  - [x] 11.1 Implement `DeficiencyAnalysis` in `code/experiment/deficiency.py`
...
- [x] 12. Implement spatial embedding quality measurement
  - [x] 12.1 Implement `SpatialEmbeddingQuality` in `code/experiment/spatial_quality.py`
...
- [x] 13. Checkpoint — Verify analysis infrastructure
  - Ensure all tests pass, ask the user if questions arise.
...
- [x] 14. Run full experiments and generate results
  - [x] 14.1 Run all learning rules (50 epochs, 3 seeds each)
  ...
  - [x] 14.2 Run deficiency analysis on all trained models
...
- [x] 15. Final checkpoint — Ensure all tests pass and results are complete
  - Ensure all tests pass, ask the user if questions arise.
