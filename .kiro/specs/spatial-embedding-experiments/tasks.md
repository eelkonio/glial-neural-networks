...
- [x] 1. Set up project structure and dependencies
  - [x] 1.1 Create directory structure and pyproject.toml
...
- [x] 2. Implement baseline MLP and data loading
  - [x] 2.1 Implement BaselineMLP in `code/model.py`
  ...
  - [x] 2.2 Implement MNIST data loading in `code/data.py`
    - Use torchvision MNIST dataset with standard train/test split
    - Configurable batch size (default 128)
    - Data normalization to [0, 1]
    - _Requirements: 2.2_

  - [x] 2.3 Implement topographic task in `code/topographic_task.py`
  ...
  - [x] 2.4 Verify baseline MLP achieves ≥95% test accuracy on MNIST
    - Train with Adam optimizer (lr=1e-3) for 20 epochs
    - Save model checkpoint to `data/` subdirectory
    - _Requirements: 2.3, 2.5_

- [x] 3. Implement embedding strategy protocol and simple embeddings
  - [x] 3.1 Define EmbeddingStrategy protocol in `code/embeddings/base.py`
  ...
  - [x] 3.2 Implement LinearEmbedding in `code/embeddings/linear.py`
  ...
  - [x] 3.3 Implement RandomEmbedding in `code/embeddings/random.py`
    - Uniform random 3D coordinates with configurable seed (default 42)
    - Deterministic: same seed produces identical output
    - _Requirements: 4.1, 4.2, 4.3_

  - [x]* 3.4 Write property tests for embedding output contract and determinism
...
- [x] 4. Implement graph-based embeddings
  - [x] 4.1 Implement SpectralEmbedding in `code/embeddings/spectral.py`
  ...
  - [x] 4.2 Implement LayeredClusteredEmbedding in `code/embeddings/layered_clustered.py`
  ...
  - [x]* 4.3 Write property test for layered-clustered x-coordinate
...
- [x] 5. Implement data-dependent embeddings
  - [x] 5.1 Implement CorrelationEmbedding in `code/embeddings/correlation.py`
  ...
  - [x] 5.2 Implement DevelopmentalEmbedding in `code/embeddings/developmental.py`
  ...
  - [x]* 5.3 Write property test for developmental force direction
    - **Property 5: Developmental force direction** — positive correlation → attractive force, zero/negative → repulsive force
    - **Validates: Requirements 8.2**

- [x] 6. Implement adversarial and differentiable embeddings
  - [x] 6.1 Implement AdversarialEmbedding in `code/embeddings/adversarial.py`
  ...
  - [x] 6.2 Implement DifferentiableEmbedding in `code/embeddings/differentiable.py`
  ...
  - [x]* 6.3 Write property tests for adversarial and differentiable embeddings
...
- [x] 7. Checkpoint - Ensure all embedding strategies work
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Implement spatial operations
  - [x] 8.1 Implement KNNGraph in `code/spatial/knn_graph.py`
  ...
  - [x] 8.2 Implement SpatialLRCoupling in `code/spatial/lr_coupling.py`
  ...
  - [x] 8.3 Implement QualityMeasurement in `code/spatial/quality.py`
  ...
  - [x] 8.4 Implement SpatialCoherence in `code/spatial/coherence.py`
  ...
  - [x] 8.5 Implement TemporalQualityTracker in `code/spatial/temporal_tracking.py`
  ...
  - [x]* 8.6 Write property tests for spatial operations
...
- [x] 9. Implement experiment infrastructure
  - [x] 9.1 Implement ExperimentRunner in `code/experiment/runner.py`
  ...
  - [x] 9.2 Implement reproducibility utilities in `code/experiment/reproducibility.py`
  ...
  - [x] 9.3 Implement visualization in `code/visualization/plots.py`
...
- [x] 11. Implement comparison experiment
  - [x] 11.1 Implement comparison experiment in `code/experiment/comparison.py`
  ...
  - [x]* 11.2 Write property tests for convergence detection and temporal degradation
...
- [x] 12. Implement analysis experiments
  - [x] 12.1 Implement boundary condition test in `code/experiment/boundary.py`
  ...
  - [x] 12.2 Implement convergence analysis in `code/experiment/convergence.py`
  ...
  - [x] 12.3 Implement three-point validation experiment
  ...
  - [x] 12.4 Implement temporal quality tracking experiment
  ...
  - [x] 12.5 Implement spatial coherence test
  ...
  - [x]* 12.6 Write property tests for three-point validation and spatial coherence
...
- [x] 13. Wire everything together and generate summary
  - [x] 13.1 Create experiment entry points and CLI
  ...
  - [x] 13.2 Create `code/embeddings/__init__.py` exporting all strategies
    - Export all 8 embedding classes from the package
    - Provide a `get_all_strategies()` convenience function
    - _Requirements: 11.6_

- [x] 14. Final checkpoint - Ensure all tests pass and experiments run end-to-end
  - Ensure all tests pass, ask the user if questions arise.
